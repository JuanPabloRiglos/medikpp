    ...
    <>
      <ArticleComponent>
        <article className=" w-full flex flex-col gap-4 my-4  justify-center">
          <div className="w-fit m-auto flex justify-center">
            {' '}
            <H2Component>
        ...
        >
          ...
          >
            <label className="italic font-semibold" htmlFor="name">
              Nombre
            </label>
            <div className="w-full border-2 flex flex-nowrap border-contrast justify-between z-0 rounded-xl py-4 px-4 ">
              <input
                className={``}
                type="text"
                id="name"
          ...
          >
            <label className="italic font-semibold" htmlFor="lastName">
              Apellido
            </label>
            <div className="w-full border-2 flex flex-nowrap border-contrast justify-between z-0 rounded-xl py-4 px-4 bg-boxBackground border-button text-effects">
              <input
                className={``}
                type="text"
                id="lastName"
          ...
          <article className="w-full flex justify-between items-center gap-2 relative">
            ...
            >
              <label className="italic font-semibold" htmlFor="phone">
                Número de teléfono
              </label>
              <div className="w-full border-2 flex flex-nowrap border-contrast justify-between z-0 rounded-xl  py-4 px-4 bg-boxBackground border-button text-effects">
                <input
          ...
          >
            ...
            <div className="w-full border-2 flex flex-nowrap border-contrast justify-between z-0 rounded-xl  py-4 px-4 bg-boxBackground border-button">
              <input
                className={``}
          ...
          <PrincipalBtn btnType="submit">Registrarse</PrincipalBtn>
        </form>
      </ArticleComponent>
    </>
  );
